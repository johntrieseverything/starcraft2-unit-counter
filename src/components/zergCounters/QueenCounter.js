                                            ...
                                            <Tab.Pane eventKey="Probe" style={{ textAlign: 'center' }}>
                                                <Row className='align-items-center'>
                                                    <Row className='mt-3 mb-3'>
                                                        <Col>
                                                            <h3>Dark Templar</h3>
                                                            <img style={{ width: '8vw' }} src={process.env.PUBLIC_URL + "/assets/Icons/Protoss Icons/Dark Templar.png"} alt='Dark Templar' />
                                                        </Col>
                                                        <Col>
                                                            <h3>High Templar</h3>
                                                        ...
                                                        <Col>
                                                            <h3>Immortal (soft)</h3>
                                                            <img style={{ width: '8vw' }} src={process.env.PUBLIC_URL + "/assets/Icons/Protoss Icons/Immortal.png"} alt='Immortal (soft)' />
                                                        </Col>
                                                    </Row>
                                                    <Row className='mt-3 mb-3'>
                                                        <Col>
