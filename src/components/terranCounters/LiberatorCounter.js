...
function LiberatorCounter(props) {
  return (
                        ...
                        <Row className='align-items-center'>
                          <Row className='mt-3 mb-3'>
                            ...
                            <Col>
                              ...
                              <img style={{ width: '8vw' }} src={process.env.PUBLIC_URL + "/assets/Icons/Zerg Icons/Hydralisk.png"} alt='Hydralisk (soft)' />
                            </Col>
                          </Row>
                        </Row>
                      </Tab.Pane>
...
export default LiberatorCounter